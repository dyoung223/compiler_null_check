...
public abstract class Flow {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("ERROR: Could not load class '" + solver_name + "' as Solver: " + ex);
      System.out.println(usage);
      return;
    }
    ...
    try {
      ...
      System.out.println(
          "ERROR: Could not load class '" + analysis_name + "' as Analysis: " + ex.toString());
      System.out.println(usage);
      return;
    }
    ...
    for (int i = 0; i < classes.length; i++) classes[i] = (jq_Class) Helper.load(args[i + 2]);
  ...
  public interface Analysis {
    ...
    /** Actually performs the transfer operation on the given quad. */
